...
#
# 链路：Brave 取数 → hot-scanner consume 评分 → daily_report 渲染 HTML
#
# 设计：
...
#   BRAVE_SEARCH_KEY  — Brave API 订阅令牌（必需）
#
# 挂 cron（每天 09:30，避开整点）：
...
SCAN_RAW="/tmp/wechat-scan-${DATE}.json"               # brave_search 原始输出
